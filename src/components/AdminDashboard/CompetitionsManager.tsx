...
// import { Competition, SchoolCategory } from '../../types';
// import { PlusCircle, X, Upload, Plus, Trash2, Users, ChevronRight } from 'lucide-react';
...
//         <h2 className="text-2xl font-bold text-gray-800 p-4">Competitions</h2>
//         <ul>
//           {competitions.map((competition, index) => (
//             <li
//               key={index}
...
//                 <span className="font-medium">{competition.name || `Competition ${index + 1}`}</span>
...
//                   {competitions[selectedCompetition].name || `Competition ${selectedCompetition + 1}`}
//                 </h3>
//                 <button
//                   onClick={() => {
//                     handleRemoveCompetition(selectedCompetition);
...
//                     <img src={competitions[selectedCompetition].icon} alt={competitions[selectedCompetition].name} className="w-20 h-20 object-cover rounded-full" />
//                   ) : (
//                     <div className="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center text-gray-500">
//                       No Icon
//                     </div>
